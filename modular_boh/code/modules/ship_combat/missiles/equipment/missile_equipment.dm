/obj/item/missile_equipment
	...
	icon = 'modular_boh/icon/obj/missile_equipment.dmi'
...
/obj/item/missile_equipment/proc/on_missile_activated(var/obj/overmap/projectile/P)
	return

// Called when the overmap projectile processes
/obj/item/missile_equipment/proc/do_overmap_work(var/obj/overmap/projectile/P)
...
/obj/item/missile_equipment/proc/on_touch_map_edge(var/obj/overmap/projectile/P)
	return

// Called to determine if the missile should attempt to enter a level even if it's not in space
/obj/item/missile_equipment/proc/should_enter(var/obj/overmap/O)
	return FALSE
