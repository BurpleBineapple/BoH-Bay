...
/obj/item/missile_equipment/passenger/on_missile_activated(var/obj/overmap/projectile/P)
	P.set_enter_zs(TRUE)
	close_hatch()

/obj/item/missile_equipment/passenger/on_touch_map_edge(var/obj/overmap/projectile/P)
