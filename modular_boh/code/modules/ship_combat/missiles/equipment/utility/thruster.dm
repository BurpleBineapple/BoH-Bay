...
/obj/item/missile_equipment/thruster/do_overmap_work(var/obj/overmap/projectile/P)
...
/obj/item/missile_equipment/thruster/should_enter(var/obj/overmap/O)
	if(O == target)
		return TRUE
	return FALSE

/obj/item/missile_equipment/thruster/proc/is_target_valid(var/obj/overmap/visitable/O)
	return ((O.sector_flags & OVERMAP_SECTOR_IN_SPACE) && !(O.sector_flags & OVERMAP_SECTOR_UNTARGETABLE) && LAZYLEN(O.map_z))

/obj/item/missile_equipment/thruster/on_touch_map_edge(var/obj/overmap/projectile/P)
...
/obj/item/missile_equipment/thruster/hunter/is_target_valid(var/obj/overmap/O)
	return istype(O, /obj/overmap/projectile)

/obj/item/missile_equipment/thruster/hunter/on_touch_map_edge(var/obj/overmap/projectile/P)
	var/turf/turf_location = get_turf(src)
	var/obj/overmap/visitable/ship/ship = waypoint_sector(turf_location)
...
/obj/item/missile_equipment/thruster/point/on_touch_map_edge(var/obj/overmap/projectile/P)
	var/turf/turf_location = get_turf(src)
	var/obj/overmap/visitable/ship/ship = waypoint_sector(turf_location)
...
/obj/item/missile_equipment/thruster/planet/is_target_valid(var/obj/overmap/O)
...
/obj/item/missile_equipment/thruster/planet/on_touch_map_edge(var/obj/overmap/projectile/P) //TODO: THIS WILL FUCKING RUNTIME
