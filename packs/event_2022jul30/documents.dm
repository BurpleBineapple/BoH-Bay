...
/obj/item/paper/lauletter1
	name = "Letter from Admiral Henry Lau"
	info = {"\
<center><h3>EXPEDITIONARY COMMAND - OBSERVATORY</h3>
<img src="eclogo.png" /></center>
<p><tt><tt><strong>FROM:</strong> Admiral Nevada Mii'na, SolGov Fleet<br /><strong>TO:</strong> Group 40 Vessel 15-D16, SGV Dagon<br /><strong>CC:</strong> Flag Admiral Mikhail Ahmed, Commandant of the SG Fleet<br /><strong>SUBJECT:</strong> Update to the SGV Dagon<br /></tt></tt></p>
<hr />
<p>Good day, SGV Dagon. For the purposes of reality this document can be disseminated to anyone within your retinue of Line Officers and support staff, but try to keep things secure, and need-to-know where applicable. And, please, most importantly, make sure this doesn't need to be scrubbed from the ship's systems again.</p>
<p>You'll pardon me for the colloquialisms, but things aren't in a particularly great state as it stands right now. The SGV Dagon is at the center of a controversy in regards to what is happening within the governance right now, and doubly so within the Fleet. A lot of pressure is coming from the Senate and the Assembly both to put us in a tight spot.</p>
<p>It's been difficult for Admiral Ahmed to keep things running smoothly with other organizations due to this. And to do so, we've had to make some concessions in regards to how things are being ran for now. Particularly, the Fleet has to be placated rather heavily for us to continue operating in the way we are. For the time being this doesn't effect you, at least directly, and if this changes you will be informed via fax or direct report.</p>
<p>As always, we have staff on standby to answer your faxes and offer order clarification in the event it's required, and you should also remember to ask for clarifications&nbsp;<em>before&nbsp;</em>following orders you may view as strange, cruel or unusual. We are counting on you to be an example right now, do not let us down Dagon.</p>
<p>Updates on the encroaching situation will be sent to you on a need-to-know basis with the approval of Admiral Ahmed. For the time being, continue operations as normal. Record the status of your bluespace drive regularly, forward any unknown vessels that you encounter to us, and remember the oaths you all took. Avoid danger, but don't run away. Godspeed.</p>
<hr />
