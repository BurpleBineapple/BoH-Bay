	...
	#include "torch_security_state.dm" //May need an overwrite eventually if you don't like baystation12's modern lighting system. Very subjective though. -PurplePineapple
	...
	//Required for Hestia obj
	#include "../../modular_boh/code/game/ranks/hestia_ranks.dm"
	...
	#include "../../modular_boh/code/modules/jobs/torch_jobs_hestia.dm"
	#include "../../modular_boh/code/modules/jobs/outfits/hestia_outfits.dm"
