...
#undef HUMAN_ONLY_JOBS
	...
	allowed_jobs = list(
		...
		/datum/job/liaison, /datum/job/bodyguard, /datum/job/representative, /datum/job/sfpagent, /datum/job/sea, /datum/job/sea/marine, /datum/job/psiadvisor,
		/datum/job/bridgeofficer, /datum/job/pathfinder, /datum/job/nt_pilot, /datum/job/explorer,
		/datum/job/squad_lead, /datum/job/combat_tech, /datum/job/combat_medic, /datum/job/grunt,
		/datum/job/senior_engineer, /datum/job/engineer, /datum/job/roboticist, /datum/job/engineer_trainee,
		/datum/job/officer, /datum/job/seccadet, /datum/job/warden, /datum/job/detective,
